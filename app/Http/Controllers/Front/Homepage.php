...
class Homepage extends Controller
{
    ...
    {
        if (Config::first()->active!=1){
            echo "<h1 style='text-align: center'>Site Bakımda</h1>";
            die;
        }

        /** PAGES VE CATEGORİES ÇOĞU SAYFADA OLDUĞU İÇİN SÜREKLİ KOD TEKRARINDAN KAÇINARAK UFAK BİR KOD YAZALIM */
        view()->share("pages", Page::where("status", 1)->orderBy('order', 'asc')->get());
        /** PAGES DEĞİŞKENİNİ TÜM SAYFALARA GÖNDERDİK */
        view()->share("categories", Category::where("status", 1)->inRandomOrder()->get());
        /** CATEGORİES DEĞİŞKENİNİ TÜM SAYFALARA GÖNDERDİK */
    ...
    public function contactPost(Request $request)
    {
        ...
        $data['mesaj'] = $request->message;
        /** BURADA MESAJ DİYE İNDİS OLUŞTURMAMIZIN SEBEBİ LARAVEL İÇERİSİNDE ÇAKIŞMA DURUMUNDAN DOLAYIDIR */
